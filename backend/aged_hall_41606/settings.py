"""
Django settings for aged_hall_41606 project.
...
ROOT_URLCONF = 'aged_hall_41606.urls'
...
WSGI_APPLICATION = 'aged_hall_41606.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_hall_41606 API",
    "DESCRIPTION": "API documentation for aged_hall_41606 App",
    "VERSION": "v1",
}
